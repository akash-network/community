...
- Niccolas gave a presentation about Fleek.xyz , another client that will allow for users to leverage the Akash Network.
...
- Started as [Fleek.co](https://fleek.co/).
- [Fleek.xyz](https://fleek.xyz/) is new tech focused on web3.
- Fleek.xyz is fully modular, service based, open source, and protocal-agnosstic.
- Fleek.xyz has already been working on a Proof of Concept with Akash Network. Their team is working on an integration.
...
- Tyler will connect with Luna team to see when Client Libraries are ready to Demo.
