...
3. Create support issue for minimum commission for validators (https://www.mintscan.io/akash/proposals/26), for community to work on. (Artur has already done this: https://github.com/akash-network/support/issues/18)
