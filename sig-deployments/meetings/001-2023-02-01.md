...
- Anil had the perspective that sig-deployments was a technical special interest group that focused on deployment that happened across different clients. 
- Sig-clients is already working on a number of initiatives, and the participants decided there was no real need for sig-deployments.
...
- The participants came to unanimous decision that sig-deployments may not need to meet regularly. 
