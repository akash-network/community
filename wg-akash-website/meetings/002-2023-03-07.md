...
-Tyler suggested that the ecosystem page should be focuses around clients. Eg.
...
- Filtering would help to navigate through projects
...
Actions items:
- create bugs or features (categorize them, short or long term) and submit to Github
